...
$config = array (	
        ...
        // 升级订单
        'notify_url' => base_url('order/upgradePaymentZfbNotify'),
        'return_url' => base_url('order/upgradePaymentZfbReturn'),
        // 首次下订单
		//异步通知地址
		'product_notify_url' => base_url('order/productPaymentZfbNotify'),
		
		//同步跳转
		'product_return_url' => base_url('order/productPaymentZfbReturn'),
