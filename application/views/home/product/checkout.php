    ...
    <div class="container">
        <div class="form-box col-sm-8 full-width">
            ...
            <form class="simple_form card_form form-vertical form-validate" role="form" novalidate="novalidate"
                ...
                <input type="hidden" name="plan" id="plan" value="ca-anime-1-month-subscription">
                <input type="hidden" name="plan_title" id="plan_title" value="Anime 1 Month Subscription">
                <input type="hidden" name="option_type_shirt" id="option_type_shirt" value="48">
                <input type="hidden" name="option_type_pants" id="option_type_pants">
                        ...
                        <div class="panel panel-default blocked" id="panel1">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="default-cursor panel-title collapse-link" data-toggle="collapse" data-parent="#accordion"
                            ...
                            <div id="collapseSelect" class="panel-collapse in" data-step="2">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 full-width mobile-col-padding-right">
                                                    <div class="form-group string required checkout_shipping_name">
                                                        ...
                                                        <div class="controls"><input class="string required" placeholder="姓名" type="text" name="checkout[shipping_address_first_name]" id="checkout_shipping_address_first_name" value="<?=$user_info['post_name']?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 full-width">
                                                    <div class="form-group string required checkout_shipping_tel">
                                                        <label class="string required control-label"
                                                               for="checkout_shipping_address_line_1" style="opacity: 0">电话<abbr title="required">*</abbr></label>

                                                        <div class="controls">
                                                            <input class="string required" placeholder="电话" type="text" name="checkout[shipping_address_line_1]" id="checkout_shipping_address_line_1" value="<?=$user_info['post_phone']?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 full-width">
                                                    <div class="form-group string optional checkout_shipping_address_line">
                                                        <label class="string optional control-label" for="checkout_shipping_address_line" style="opacity: 0;">送货地址</label>
                                                        <div class="controls">
                                                            <input class="string optional"placeholder="送货地址" type="text" name="checkout[shipping_address_line_2]" id="checkout_shipping_address_line" value="<?=$user_info['post_addr']?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="controls align-left next_step">
                                    <button name="button" type="submit" class="btn btn-primary mobile-full-width next"
                        ...
                        <div id="cosummarypricebreakdown">
                            ...
                            <div class="row subscription-coupon">
                                ...
                                <div class="col-xs-3 no-left-padding">
                                    <span class="subscription-coupon" id="coupon-discount-amount">¥5.00</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3 no-left-padding total-amount"><span id="subscription-today-total"> <b><span>¥183</span><span></span></b> </span>
                                </div>
                            </div>
                        </div>
                    </div>
