                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <div class="col-xs-12 no-padding">
                                        <div class="cr-notice">Please login to verify your Crunchyroll Premium
                                            account and redeem your additional $5.00 savings on Loot Anime.
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 full-width">
                                                <div class="form-group string optional checkout_shipping_address_line">
                                                    ...
                                                    <div class="controls">
                                                        <input class="string optional" placeholder="送货地址" type="text"
