...
<form id="main-form" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" name="cover_image" placeholder="请上传封面图片">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" name="introduction_image" placeholder="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" name="gift_image" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="bannber_image1" class="col-sm-2 control-label">轮播图1</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="bannber_image1" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="bannber_image2" class="col-sm-2 control-label">轮播图2</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="bannber_image2" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="bannber_image3" class="col-sm-2 control-label">轮播图3</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="bannber_image3" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="bannber_image4" class="col-sm-2 control-label">轮播图4</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="bannber_image4" placeholder="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" name="image1" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="image2" class="col-sm-2 control-label">物品图2</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="image2" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="image3" class="col-sm-2 control-label">物品图3</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="image3" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="image4" class="col-sm-2 control-label">物品图4</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="image4" placeholder="">
        </div>
    </div>
    <div class="form-group">
        <label for="characteristic" class="col-sm-2 control-label">特征</label>
        <div class="col-sm-9">
            <textarea class="" rows="12" placeholder="特征" placeholder=""></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="logistics" class="col-sm-2 control-label">送货</label>
        <div class="col-sm-9">
            <textarea class="" rows="12" placeholder="送货" placeholder=""></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="about" class="col-sm-2 control-label">关于主题</label>
        <div class="col-sm-9">
            <textarea class="" rows="12" placeholder="关于主题" placeholder=""></textarea>
        </div>
    </div>
    <div class="form-group">
