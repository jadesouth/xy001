...
<form id="main-form" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" name="banner_image1_url" value="<?=$data['banner_image1']?>">
            <img class="img-thumbnail" style="display: block" src="<?=$data['banner_image1']?>">
            <p class="help-block">支持jpg、jpeg、png、gif格式，大小不超过4.0M</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" name="banner_image2_url" value="<?=$data['banner_image2']?>">
            <img class="img-thumbnail" style="display: block" src="<?=$data['banner_image2']?>">
            <p class="help-block">支持jpg、jpeg、png、gif格式，大小不超过4.0M</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" name="banner_image3_url" value="<?=$data['banner_image3']?>">
            <img class="img-thumbnail" style="display: block" src="<?=$data['banner_image3']?>">
            <p class="help-block">支持jpg、jpeg、png、gif格式，大小不超过4.0M</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" name="banner_image4_url" value="<?=$data['banner_image4']?>">
            <img class="img-thumbnail" style="display: block" src="<?=$data['banner_image4']?>">
            <p class="help-block">支持jpg、jpeg、png、gif格式，大小不超过4.0M</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" name="banner_title1" placeholder="" value="<?=$data['banner_title1']?>">
        </div>
    </div>
    <div class="form-group">
        <label for="banner_title2" class="col-sm-2 control-label">轮播图标题2</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="banner_title2" placeholder="" value="<?=$data['banner_title2']?>">
        </div>
    </div>
    <div class="form-group">
        <label for="banner_title3" class="col-sm-2 control-label">轮播图标题3</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="banner_title3" placeholder="" value="<?=$data['banner_title3']?>">
        </div>
    </div>
    <div class="form-group">
        <label for="banner_title4" class="col-sm-2 control-label">轮播图标题4</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" name="banner_title4" placeholder="" value="<?=$data['banner_title4']?>">
        </div>
    </div>
    <div class="form-group">
